        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid" style="background-color:#9F0D20">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" style="color:white" href="#">Status Bangunan</a>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#inputstatus">Input Data</button>
                        </div>
                    </div>
                </div>
                <br>
                        ...
                        <div class="table-responsive">
                            <table id=tableadmin class="table table-md table-bordered">
                                <tr style="background-color:#9F0D20;color:white;">
                                    <th class="font-weight-bold" style="text-align: center;">ID Status</th>
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td>
                                        <button class="btn btn-success btn-sm" id="getStatus" data-toggle="modal" data-target="#editstatus" data-url="{{ route('dynamicModal3',['id'=>$data->statusid])}}">Edit</button>
                                        {!!Form::open(['method'=>'delete','route'=>['StatusBangunan.destroy',$data->statusid],'style'=>'display:inline'])!!}
...
<div class="wrapper">
        <div class="modal fade bd-example-modal-sm" id="inputstatus"  tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @endif
                        <form action="{{ url('/StatusBangunan') }}" method="post">
                        {{ csrf_field() }}
        ...
        <div id="editstatus" class="modal fade bd-example-modal-sm"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
