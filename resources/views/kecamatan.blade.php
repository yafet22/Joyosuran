                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#inputkecamatan">Input Data</button>
                        </div>
                    </div>
                </div>
                <br>
                        ...
                        <div class="table-responsive">
                            <table id=tableadmin class="table table-md table-bordered">
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td>
                                        <button class="btn btn-success btn-sm" id="getKecamatan" data-toggle="modal" data-target="#editkecamatan" data-url="{{ route('dynamicModal4',['id'=>$data->kecamatanid])}}">Edit</button>
                                        {!!Form::open(['method'=>'delete','route'=>['Kecamatans.destroy',$data->kecamatanid],'style'=>'display:inline'])!!}
...
<div class="wrapper">
        <div class="modal fade bd-example-modal-sm" id="inputkecamatan"  tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div id="editkecamatan" class="modal fade bd-example-modal-sm"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(document).on('click', '#getKecamatan', function(e){
